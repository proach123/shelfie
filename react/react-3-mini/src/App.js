...
class App extends Component {
  ...
  getPotentialBuyers() {
    ...
    this.setState({
      ...
      toast.success('They might buy')
    }).catch(error=>{
      toast.error('The potential buyers is off')
    })
  }
  ...
  sellCar(id) {
    ...
    this.setState({
      ...
      toast.error('vehicle removal failed')
    })
    // axios (DELETE)
    // setState with response -> vehiclesToDisplay
  }
...
axios.get(`https://joes-autos.herokuapp.com/api/vehicles`).then((response)=>{
  ...
  toast.success('make is filtering')
}).catch(error=>{
  toast.error('make filter is malfunctioning.')
})
    // axios (GET)
    // setState with response -> vehiclesToDisplay
  }
...
axios.get(`https://joes-autos.herokuapp.com/api/vehicles`).then((response)=>{
  ...
  toast.success('color is filtering')
}).catch(error=>{
  toast.error('colors are not filtering.')
})
    // axios (GET)
    // setState with response -> vehiclesToDisplay
  }
